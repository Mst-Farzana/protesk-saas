  ...
  <div>
    ...
    <div v-else class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <div
        ...
        :key="category.id"
        class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800 transition hover:shadow-md"
      >
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Slug:
          <code class="rounded bg-gray-100 px-1 dark:bg-gray-700">{{ category.slug }}</code>
        </p>
      </div>
    </div>
  </div>
